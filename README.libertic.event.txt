* A project has been created in /tmp/tmp7lsB0K.

* A minilay has been installed in /tmp/tmp7lsB0K/minilays/libertic.event.
...
* The project must be archived here 'ssh://git@github.com/LiberTIC-Nantes/libertic.event.buildout.git' using 'git' or change the minibuild src_uri/scm_type.
